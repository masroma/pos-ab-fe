<template>
    <div class="w-full justify-center h-screen  items-center mx-auto  py-20  px-2">
            ...
            <div class="bg-white p-5 shadow-lg rounded-lg flex flex-col">
                ...
                <form @submit.prevent="login" class="my-5 flex flex-col gap-y-5">
                    <div class="flex flex-col gap-y-2">
                        <p :class="validation.email ? 'text-red-500' : 'text-cyan-600'">
                            Email
                        </p>

                        <div
                            :class="['flex', 'border-2', { 'border-red-500': validation.email }, 'border-cyan-600', 'rounded-lg']">
                    ...
                    <div class="flex flex-col gap-y-2">
                        <p :class="validation.password ? 'text-red-500' : 'text-cyan-600'">
                            Password
                        </p>
                        <div
                            :class="['flex', 'border-2', { 'border-red-500': validation.password }, 'border-cyan-600', 'rounded-lg']">
